# dandenney.com Mimic — Implementation Todo List

## Homepage
- [ ] Hero section with animated title + intro paragraph
...
- [x] Card grid layout (image bg + gradient overlay + hover effects)
- [x] Header section with post count + page title + description
- [x] Image hover: scale 105% + lift text + shadow
- [ ] Blog Roll section (curated external links)
- [ ] Featured quote section (e.g., Chris Coyier)
- [ ] Responsive srcset for images

## Individual Blog Post
- [x] Breadcrumb navigation
- [x] TOC sidebar (sticky, scroll-spy)
...
- [ ] Cloudinary image optimization (responsive srcset)
...
- [ ] YIL collection (Today I Learned)
- [ ] Tinkerings collection
- [ ] Music collection
